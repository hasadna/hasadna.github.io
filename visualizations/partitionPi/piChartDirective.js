...
App.directive('ghVisualization', function(piChartService, commentsHandler) {
    var id_const = 'pi_id_';
    ...
    return {
        ...
        link: function(scope, element, attrs) {
            scope.$watch('visible', function(vis) {
                ...
                piChartService.getJSON(function(data) {
            ...
            piChartService.visibilityFunction = function(isVisible) {
